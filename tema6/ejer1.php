...
<body>
    ...
    class Persona
    {
        ...
        public function sueldoMasComision()
        {
            ...
            //Referencia a la constante Persona::COMISION como si fuera un echo tiene que ser  echo Persona::COMISION
            echo "sueldo  + comisión: " . (Persona::COMISION + $this->sueldo); //también self::COMISION       
        }
        public function __destruct()
        { //Es opcional. Sólo debemos crearlo si deseamos hacer alguna cosa cuando un objeto se elimine de la memoria. 
            echo '<br>';
